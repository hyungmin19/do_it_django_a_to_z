...
import os # 이미지 업로드를 위한 imagefield 때문
...
SECRET_KEY = 'django-insecure-qq^-7b%$n+8=r+!ihagsnq_*3w!ldahh4vqwit0$*37n-)r8&t'
...
# MEDIA_URL은 media로 지정
# 이미지 파일은 프로젝트 폴더 아래 _media라는 이름의 폴더를 만들고 그 안에 저장하도록 함.
